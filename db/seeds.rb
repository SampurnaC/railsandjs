...
Product.create!(name: "Tasty Baklava", price: 3.99, category_id: Category.find_by(name: "Dry Foods"))
Product.create!(name: "Flux Capacitor", price: 19.55, category_id: Category.find_by(name: "Other Electronics"))
Product.create!(name: "Technodrome", price: 12.49, category_id: Category.find_by(name: "Toys"))
Product.create!(name: "TextMate 2", price: 74.99, category_id: Category.find_by(name: "Software"))